...
console.log(DayOfWeek.entries()); // [["sunday", 0], ["monday", 1], ["tuesday", 2], ["wednesday", 3], ["thursday", 4], ["friday", 5], ["saturday", 6]]
console.log(DayOfWeek.names()); // ["sunday", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday"]
console.log(DayOfWeek.values()); // [0, 1, 2, 3, 4, 5, 6]
